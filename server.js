...
app.get('/EarningsBeforeDepreciationAndTaxesCalculator', calculator.earningsBeforeDepreciationAndTaxesCalculator);
...
app.get('/ValueOfARightCalculator', calculator.valueOfARightCalculator);
